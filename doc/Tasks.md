...
|---------|--------|------|----------|----------|----------|-------------|------|----------|--------|------------|
| **T-30018** | Android | Theme | MenaTheme 中东黑金主题系统 [TDS](./tds/android/T-30018.md) | 无 | 封装 Material3 黑金主题（Colors/Typography/Shapes）+ RTL Provider + GoldButton / GoldOutlinedTextField / AvatarWithFrame 通用组件 | 1. `MenaTheme {}` 内自动黑金色系<br>2. GoldButton 金色渐变+白字+24dp圆角<br>3. RTL 自动生效 | In Progress | 6h | TDD | [T-30018.md](./design/android/T-30018.md) |
