...
### Redis Pub/Sub（admin:events 发布方）
| # | 事件类型 | 发布入口 | 消费方 | 锚点 |
|---|---------|---------|--------|------|
| 1 | `admin:events :: BanUser` ⭐ | `modules/user/service.rs::ban_user` | server/events/handler.rs | [BanUser.schema.json](../../protocol/schemas/pubsub/BanUser.schema.json) |
| 2 | `admin:events :: UnbanUser` ⭐ | `modules/user/service.rs::ban_user(is_banned=false)` | server/events/handler.rs | [UnbanUser.schema.json](../../protocol/schemas/pubsub/UnbanUser.schema.json) |
| 3 | `admin:events :: CloseRoom` ⭐ | `modules/room/service.rs::force_close_room` | server/events/handler.rs | [CloseRoom.schema.json](../../protocol/schemas/pubsub/CloseRoom.schema.json) |
| 4 | `admin:events :: BroadcastNotice` ⭐ | `modules/event/notice_service.rs::broadcast` | server/events/handler.rs | [BroadcastNotice.schema.json](../../protocol/schemas/pubsub/BroadcastNotice.schema.json) |
