...
| **T-30019** | Android | Splash | Splash 启动页 [TDS](./tds/android/T-30019.md) | T-30018 | 品牌 Splash 页：Logo 缩放动画 → JWT 检测 → 自动导航到 MainScreen 或 LoginScreen | 1. Logo 缩放+淡入动画 800ms<br>2. 有效 JWT → MainScreen<br>3. 无效 JWT → LoginScreen<br>4. 返回键不可回退到 Splash | In Progress | 4h | DoD | [T-30019.md](./design/android/T-30019.md) |
