...
| **T-30021** | Android | Auth | 登录页视觉升级 [TDS](./tds/android/T-30021.md) | T-30018 | 将现有 LoginScreen 从白色主题改造为黑金风格：渐变背景 + GoldOutlinedTextField + GoldButton。功能逻辑不变 | 1. 深色渐变背景<br>2. 所有输入框用 GoldOutlinedTextField<br>3. 按钮用 GoldButton<br>4. **现有功能测试不回归** | In Progress | 3h | TDD | [T-30021.md](./tds/android/T-30021.md) |
