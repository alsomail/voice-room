...
| **T-30020** | Android | Navigation | MainScreen 底部三Tab框架 [TDS](./tds/android/T-30020.md) | T-30018, T-30019 | BottomNavigation 三Tab（房间/消息/我的），Tab切换保持状态 | 1. 默认显示房间Tab<br>2. 三Tab可切换，选中项金色<br>3. Tab切换保持各页面状态 | In Progress | 5h | TDD | [T-30020.md](./design/android/T-30020.md) |
