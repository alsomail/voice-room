...
## TC-ROOM-00007：Dashboard 概览 + ECharts + 30s 自动刷新
**【元数据】**
- **归属模块**：`ROOM`
- **测试类型**：`Functional`
- **回归级别**":`P1`
...
## TC-ROOM-00011：活跃房间监控增强 - 状态/时长/筛选/异常高亮（T-20011）
**【元数据】**
- **归属模块**：`ROOM`
- **测试类型**：`Functional`
- **回归级别**：`P1`
