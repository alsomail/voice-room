...
| **T-00106** | 基建 | Infra/Protocol | 协议字段级 AST 审计（升级 T-0000T）+ CI 阻塞 [TDS](../tds/infra/T-00106.md) | T-00100, T-0000T | 解析 server `json!` 宏 / Android `@SerializedName` / Web Zod；与 schemas/ 字段集合比对；mismatch 报 P0 阻塞 PR | 1. FIELD-1~3 + CI-1 全过<br>2. T-0000T 53 tests 0 回归 | 10h | Review | In Progress | - | - | ⏳ Pending |
