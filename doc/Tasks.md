...
| **T-30003** | Android | Auth | JWT 拦截器 [TDS](./tds/android/T-30003.md) | T-00004, T-30002 | OkHttp 拦截器自动添加 token | 1. 每个请求自动带 Authorization Header<br>2. 401 响应自动跳转登录页 | In Progress | 3 | TDD |
