...
| **T-30023** | Android | Messages | 消息Tab占位页 [TDS](./tds/android/T-30023.md) | T-30018, T-30020 | IM 功能占位页：PlaceholderScreen 通用组件 + "消息功能即将上线" | 1. 消息Tab显示占位页<br>2. PlaceholderScreen 可复用<br>3. 深色背景 | Todo | 2h | TDD | [T-30023.md](./design/android/T-30023.md) |
