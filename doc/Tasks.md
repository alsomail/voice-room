...
| **T-30037** | Android | Room | 房间封面选择器（8 张预设）[TDS](./tds/android/T-30037.md) | T-30036 | `CoverPickerBottomSheet`：3列网格展示 8 张中东风预设封面（沙漠/清真寺/烛灯/鹰/玫瑰/游艇/太阳/书法）；选中金色边框；首次进入默认第一张 | 1. 8 张预设归在内置 drawable<br>2. 选中状态有金色 2dp 边框<br>3. `Key('cover_option_0')`~`cover_option_7'` 可测<br>4. 确认后返回 cover_url 给父页 | In Progress | 3h | Review | [T-30037.md](./design/android/T-30037.md) |
